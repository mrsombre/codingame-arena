    ...
    <div class="blk">
      ...
      <div class="text">
        <ul style="padding-bottom: 0;">
          <li>
            You score more points than your opponent.
            <!-- BEGIN level3 level4 -->
            Each fruit in your shack scores <const>1</const> point; <const>WOOD</const> scores <const>4</const> points. <const>IRON</const> has no score value.
            <!-- END -->
          </li>
        </ul>
      </div>
...
<!-- BEGIN level1 level2 -->
In this league every character is <const>.</const> for <const>GRASS</const>.
<!-- END -->
<!-- BEGIN level3 level4 -->
  <!-- BEGIN level3 -->
  <span style="color: #7cc576; background-color: rgba(124, 197, 118,.1); padding: 2px;">
